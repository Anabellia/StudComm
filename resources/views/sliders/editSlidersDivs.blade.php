...
<!--######################################################################-->	   
                    ...
                    <!--(behavior petljaus) -->
                    <div><label for="Behavior">Behavior(from 1-5): </label>
...
<!--######################################################################-->	
            ...
            <!--Student Speaking  -->
			<div><label for="Speaking">Speaking(from 1-5): </label>
...
<!--######################################################################-->
            ...
            <!-- slider  for Reading-->
			<div><label for="Reading">Reading(from 1-5): </label>
...
<!--######################################################################-->	
            ...
            <!--Student Writing  -->
			<div><label for="Writing">Writing(from 1-5): </label>
...
<!--######################################################################-->	
            <!--Student Listening  -->
			<div><label for="Listening">Listening(from 1-5): </label>
...
<!--######################################################################-->	
			...
			<div><label for="Comprehension">Comprehension(from 1-5): </label>
...
<!--######################################################################-->	
            ...
            <!--Student Subject  -->
			<div><label for="Subject">Subject(from 1-5): </label>
...
<!--######################################################################-->	
            ...
            <!--Student Conclusion  -->
            <div>
			<label for="Conclusion">Conclusion(from 1-5): </label>
            <input type="text" id="Conclusion" name="Conclusion" value="Conclusion" readonly style="border:0; color:#f6931f; font-weight:bold;">
